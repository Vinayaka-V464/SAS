...
export default function AttendancePage() {
  ...
  const recompute = React.useCallback(() => {
    try {
      ...
      // Fill subjects as encountered; UI will order using getSubjects()
      ...
      // Sort logs by date then hour desc
  ...
  return (
    <div className="dash">
      ...
      <p className="subtitle">Subject-wise summary with detailed logs.</p>
